"""
Django settings for tributia_project project.
...
WSGI_APPLICATION = 'tributia_project.wsgi.application'


# Database
# https://docs.djangoproject.com/en/6.0/ref/settings/#databases

# En Docker (docker-compose) se inyecta POSTGRES_HOST y se usa PostgreSQL;
# en desarrollo local sin Docker no hay Postgres instalado, así que se
# mantiene SQLite como fallback para no romper el flujo de trabajo actual
# del equipo (`manage.py runserver`).
